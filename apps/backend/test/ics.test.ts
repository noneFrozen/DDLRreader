...
describe("ICS export", () => {
  ...
  it("escapes task titles and keeps block UIDs stable across exports", async () => {
    ...
    await app.inject({ method: "POST", url: "/api/tasks", payload: { title: "软件工程,大作业", deadline: "2026-08-11T12:00:00.000Z", remainingMinutes: 30 } });
    ...
    expect(exported.body).toContain("SUMMARY:软件工程\\,大作业");
