...
describe("Organic Productive workspace", () => {
  ...
  it("renders the availability entry shell with accessible state", () => {
    render(<App />);
    ...
    expect(screen.getByRole("button", { name: "可用时间" })).toHaveAttribute(
      "aria-current",
      "step",
    );
  });

  it("keeps the current step keyboard reachable", async () => {
